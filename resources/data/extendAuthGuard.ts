...
export class ExtendAuthGuard implements CanActivate {
  ...
  canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
    ...
    } else if (userInfoLocalStorage != undefined && userInfoLocalStorage != null) {
    ...
    if (GlobalService.LOGGED || null != sessionStorage.getItem('userInfo') || null != localStorage.getItem('userInfo')) {
