...
@Component({
  selector: 'gp-form-color-picker-field',
  templateUrl: './form-color-picker-field.component.html',
  styleUrls: ['./form-color-picker-field.component.scss'],
})
export class FormColorPickerFieldComponent extends GpFormFieldControl implements OnInit {
