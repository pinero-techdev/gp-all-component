...
import { FormDaysOfWeekFieldComponent } from './form-days-of-week-field.component';
import {
...
describe('FormTextFieldComponent', () => {
  let component: FormDaysOfWeekFieldComponent;
  let fixture: ComponentFixture<FormDaysOfWeekFieldComponent>;
  let formField: GpFormField;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [FormDaysOfWeekFieldComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FormDaysOfWeekFieldComponent);
