    ...
    describe('when login', () => {
        ...
        it('should set a new session with the user info', () => {
            ...
            service.login(loginRequest).subscribe((data: any) => {
                ...
                expect(GlobalService.setSessionId).toHaveBeenCalledWith(
                    httpLoginResponse.sessionId
                );
    ...
    describe('when session is active', () => {
        ...
        it('should return the session object', () => {
            ...
            service.sessionInfo().subscribe((session) => {
                ...
                expect(sessionStorage.getItem('userInfo')).toEqual(JSON.stringify(userInfo));
                expect(sessionStorage.getItem('sessionId')).toEqual(httpLoginResponse.sessionId);
            });
        });
    });
    ...
    describe('when there is not session active', () => {
        ...
        it('should return an empty session object', () => {
            ...
            service.sessionInfo().subscribe((session) => {
                ...
                expect(sessionStorage.getItem('userInfo')).toEqual(null);
