...
export class GpFormDropdownFieldComponent extends GpFormFieldControl implements OnInit {
  ...
  set _currentValueDropDown(value: string) {
    ...
    const infoCampoModificado = new InfoCampoModificado(this.formField.fieldMetadata.fieldName, this.currentValue);
  ...
  inicializa() {
    ...
    if (this.formField.fieldMetadata.displayInfo && this.formField.fieldMetadata.displayInfo.options != null
    ...
    } else if (this.formField.fieldMetadata.displayInfo && this.formField.fieldMetadata.displayInfo.referencedTable != null
      ...
      this._tableService.list(this.formField.fieldMetadata.displayInfo.referencedTable, true, true, fieldToOrderBy,
  ...
  onChange() {
    const infoCampoModificado = new InfoCampoModificado(this.formField.fieldMetadata.fieldName, this._currentValueDropDown);
    this.valueChanged.emit(infoCampoModificado);
  }
