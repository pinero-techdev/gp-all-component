...
import { MultiIdiomaTesterComponent } 
from './multi-idioma-tester/multi-idioma-tester.component';
...
@NgModule({
    ...
    imports: [BrowserModule, CommonModule, FormsModule, GpAllComponentModule],
    providers: [],
