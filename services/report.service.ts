  ...
  getDialogElements(report: string): GetDialogElementsRs {
    ...
    switch (report) {
      case 'CLDRW031':
        ...
        let field: FieldMetadata = new FieldMetadata(
          5,
          'hotel',
          'STRING',
          false,
        ...
        field = new FieldMetadata(
          ...
          15,
          null,
          new FieldDisplayInfo('Fecha desde', 2, 'CALENDAR', '', '', null, null, null, null, null, null, null, null, null, null)
        );
        dialogElements.metadata.push(field);
        field = new FieldMetadata(
          5,
          ...
          15,
          null,
          new FieldDisplayInfo('Fecha hasta', 3, 'CALENDAR', '', '', null, null, null, null, null, null, null, null, null, null)
        );
        dialogElements.metadata.push(field);
        field = new FieldMetadata(
          5,
          ...
          15,
          null,
          new FieldDisplayInfo('Clasificación', 4, 'DROPDOWN', '', '', null, 'CdEcla', 'eclaNomb', null, null, null, ['eclaDesc'], null, null, null)
        );
        dialogElements.metadata.push(field);
        field = new FieldMetadata(
          5,
          ...
          15,
          null,
          new FieldDisplayInfo('Departamento', 5, 'DROPDOWN', '', '', null, 'CdEdpt', 'edptNomb', null, null, null, ['edptDesc'], null, null, null)
        );
        dialogElements.metadata.push(field);
        field = new FieldMetadata(
          5,
