...
import { GpAppLoadingIndicatorModule } from './components/loading-indicator/gp.app.loading-indicator.component';
...
import { GpAppQlikviewFrameComponent } from './components/qlikview/gp.app.qlikview.frame.component';
import { GpAppReportDialogComponent } from './components/reports/gp-app-report-dialog.component';
import { GpAppReportFrameComponent } from './components/reports/gp-app-report-frame.component';
import { GpFormDropdownDynamicFieldComponent } from './components/tables/gp-form-dropdown-dynamic-field.component';
import { GPTreeTableComponent } from './components/tables/gp-treetable.component';
import { GpAppTableCrudYieldComponent } from './components/tables/gp-app-table-crud-yield.component';
...
@NgModule({
  imports: [
    ...
    TreeModule,
    TriStateCheckboxModule,
    GpAppLoadingIndicatorModule
  ],
  exports: [
    // Directives.
    FocusDirective,
    GPLowercaseDirective,
    GPUppercaseDirective,

    // Components.
    GPDynamicComponent,
    GpAppTableCrudYieldComponent,
    GPTreeTableComponent,
    GpFormDropdownDynamicFieldComponent,
    ...
    GpAppModificaPasswordComponent,
    GpAppMultiIdiomaComponent,
    GpAppMultiSelectComponent,
    GpAppRatingComponent,
    GpAppRedirectComponent,
    GpAppRemoteFsysPickerComponent,
